...
<section class='sec4'>
	<div class='container fullwidth'  style="background: rgba(255, 255, 255, 0.30);">
		<div class='row' style="margin-top: 25%;margin-bottom: 10%;">
			<a href="pages/bus.php"  class="text_decoration blackcolor">
			...
			<a href="pages/train.php" class="text_decoration blackcolor">
			...
			<a href="pages/waterbus.php"  class="text_decoration blackcolor">
